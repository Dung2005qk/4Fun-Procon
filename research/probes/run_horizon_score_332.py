...
LIMITS = {"settledLabels": 32768, "createdLabels": 196609, "storedActions": 262144,
    ...
    try:
        for i, c in enumerate(cases):
            for side in c["order"]:
                ...
                require(memory_available() >= 768*1024*1024, "available RAM below frozen 768MiB safety floor")
