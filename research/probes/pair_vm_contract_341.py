...
def freeze():
    ...
    import test_pair_stock_bound_341 as t
    ...
    queries.append(a)
    binary=ROOT/'artifacts/research/341/probe.exe';p=Bridge(binary)
    ...
    path=ROOT/'research/evidence/SCORE-W1-STOCK-RELAXED-PAIR-PRICING-341-vm-contract.json'
    save(path,{'experiment':'341','authority':'17 tiny deterministic cross-compiler equivalence/rollback checks; not paired score or latency.',
